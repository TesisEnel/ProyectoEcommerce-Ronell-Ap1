    ...
    public partial class Inicial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TipoTelId = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    TipoTelefonos = table.Column<string>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TelefonosClientes", x => x.TipoTelId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClientesDetalle", x => x.DetalleIdCliente);
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "TipoTelId", "TipoTelefonos" },
                values: new object[,]
                {
                    { 1, "Telefono Local" },
                    { 2, "Celular" },
